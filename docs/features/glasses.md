...
<!-- media: hero shot through the glasses HUD -> assets/img/glasses-hud.png -->
...
<!-- media: clip of a hands-free voice turn -> assets/video/glasses-voice.mp4 -->
...
<!-- media: clip demonstrating tap / hold / scroll -> assets/video/glasses-touchpad.mp4 -->
...
<!-- media: example captured frame -> assets/img/glasses-capture.jpg -->
...
<!-- media: screenshot of a rendered HUD reply -> assets/img/glasses-hud-reply.png -->
