...
<!-- media: hero shot of the phone app home screen -> assets/phone-home.png -->
...
<!-- media: clip of a voice turn end-to-end -> assets/phone-chat.mp4 -->
...
<!-- media: clip showing wake-word trigger -> assets/phone-wakeword.mp4 -->
...
<!-- media: screenshot of the navigation view -> assets/phone-nav.png -->

## ReID dashboard

Browse recognized people sourced from the ReID pipeline.

<!-- media: screenshot of the people list -> assets/phone-reid-list.png -->
...
<!-- media: screenshot of the relay / pairing screen -> assets/phone-relay.png -->
